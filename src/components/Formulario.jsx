   ...
   setSintomas('')
    ...
    return (
      ...
      <div className='md:w-1/2 lg:w-2/5'>
        ...
        <h1 className="font-black text-3xl text-center" >God Bless You Seguimiento Pacientes.</h1>
      ...
      {error && <Error> <p>God bless you every time in the name of JESUS CRISTO.</p> </Error> }
       ...
       <form 
            ...
            className='bg-white shadow-md rounded-lg py-10 px-5 mb-10'>
              ...
              <div className='mb-5'>
                   <label htmlFor='mascota' className='block text-gray-700 uppercase font-bold'>Nombre Mascostas</label>
              ...
              <div className='mb-5'>
                   ...
                   className='block text-gray-700 uppercase font-bold'>Nombre </label>
